    ...
    <div className="slider-container">
      ...
      <div className='carouselContainer'>
        <Carousel responsive={responsive}>
            <div className="card">
              <img src="/images/home/Colosseum_11-7-2003.jpg" alt=""/>     
            </div>
            <div className="card">
              <img src="/images/home/Na_Koloseum_i_K_Franciszki_Rzymianki.jpg" alt=""/>     
            </div>
            <div className="card">
              <img src="/images/home/Roma_(2005).jpg" alt=""/>     
            </div>
            <div className="card">
              <img src="/images/home/Roma_Piazza_Venezia.jpg" alt=""/>     
            </div>
            <div className="card">
              <img src="/images/home/Roma-prati.jpg" alt=""/>     
            </div>
        </Carousel> 
      </div>
